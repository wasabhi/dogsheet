...
DogSheet is an app for time tracking.  It's primary goal is to provide <strike>a
time tracking interface for Pivotal Tracker http://www.pivotaltracker.com/</strike>
a quick way to track time quickly and generate invoices in Xero http://xero.com/,
